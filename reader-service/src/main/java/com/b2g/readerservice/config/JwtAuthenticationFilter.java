...
//
//        // Proteggi SOLO POST su /content/**
//        if (pathMatches("/content/**", path) && "POST".equals(method)) {
//            return false; // applica il filtro
//        }
//
//        // Proteggi sempre /readers/me/**
//        if (pathMatches("/readers/me/**", path)) {
//            return false; // applica il filtro
//        }
//
//        // Tutto il resto NON filtrato
//        return true;
//    }
