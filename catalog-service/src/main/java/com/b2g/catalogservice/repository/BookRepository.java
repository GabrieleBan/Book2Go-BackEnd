...
@Repository
public interface BookRepository extends JpaRepository<CatalogBook, UUID>, JpaSpecificationExecutor<CatalogBook> {
    ...
    boolean existsByAuthorAndTitleAndEditionAndPublisher(String author, String title, String edition, String publisher);
}
